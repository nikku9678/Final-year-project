      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-black-800 hover:bg-yellow-600 hover:text-black focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-100">
          ...
          <div className="flex flex-1 items-center ml-12 sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center text-lg font-medium">
              Goal Manager
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? ' text-black-800' : 'text-black-300  hover:text-blue-800',
        ...
        <div className="space-y-1 px-5 pb-3 pt-2">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              aria-current={item.current ? 'page' : undefined}
              className={classNames(
                item.current ? 'bg-yellow-600 text-black' : 'text-black-300 hover:bg-gray-700 hover:text-white',
